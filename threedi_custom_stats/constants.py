...
agg_var_list = [
    ...
    {'short_name': 'rain_depth', 'long_name': 'Rain depth', 'signed': False,
     'applicable_methods': ALL_AGG_METHODS, 'var_type': VT_NODE, 'units': {('mm', 's'): (1000, 1), ('mm', 'h'): (1000, 3600)},
     'can_resample': True, 'pre_resample_method': PRM_NONE},
    {'short_name': 'infiltration_rate', 'long_name': 'Infiltration rate', 'signed': False, 
     'applicable_methods': ALL_AGG_METHODS, 'var_type': VT_NODE, 'units': {('m3', 's'): (1,1), ('m3','h'): (1, 3600)},
     'can_resample': True, 'pre_resample_method': PRM_NONE},
    {'short_name': 'infiltration_rate_mm', 'long_name': 'Infiltration rate per m2', 'signed': False,
     'applicable_methods': ALL_AGG_METHODS, 'var_type': VT_NODE, 'units': {('mm', 's'): (1000, 1), ('mm', 'h'): (1000, 3600)},
     'can_resample': True, 'pre_resample_method': PRM_NONE},
