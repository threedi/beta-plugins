...
agg_var_list = [
    ...
    {'short_name': 'infiltration_rate', 'long_name': 'Infiltration rate', 'signed': False, 
    ...
    {'short_name': 'infiltration_rate_mm', 'long_name': 'Infiltration rate per m2', 'signed': False, 'applicable_methods': ALL_AGG_METHODS, 'var_type': VT_NODE, 'units': {('mm', 's'): (1, 1), ('mm', 'h'): (1, 3600)}, 'can_resample': True, 'pre_resample_method': PRM_NONE},
    ...
    {'short_name': 'uc', 'long_name': 'Flow velocity at cell center', 'signed': False, 'applicable_methods': ALL_AGG_METHODS_NO_SUM, 'var_type': VT_NODE, 'units': {('m', 's'): (1, 1)}, 'can_resample': True, 'pre_resample_method': PRM_NONE},
    {'short_name': 'ucx', 'long_name': 'Flow velocity in x sign at cell center', 'signed': True, 'applicable_methods': ALL_AGG_METHODS_NO_SUM, 'var_type': VT_NODE, 'units': {('m', 's'): (1, 1)}, 'can_resample': True, 'pre_resample_method': PRM_NONE},
    {'short_name': 'ucy', 'long_name': 'Flow velocity in y sign at cell center', 'signed': True, 'applicable_methods': ALL_AGG_METHODS_NO_SUM, 'var_type': VT_NODE, 'units': {('m', 's'): (1, 1)}, 'can_resample': True, 'pre_resample_method': PRM_NONE},
    # 'Leakage' ???
